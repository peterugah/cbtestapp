...
class uploads extends generalFunc {
...
public function resize($target, $newcopy, $w, $h, $ext) {
  ...
  public function attach_file($file) {
	...
	public function save() {
		...
		$target_path ="uploads/{$this->filename}";
		  
		  // if file exit rename the file
		  if(file_exists($target_path)) {
		  	$this->errors[] = "This File Already Exist";
